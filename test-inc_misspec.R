...
testpars <- list(
  last_obs_time = 150,
  output_folder = 'misspec_incubation',
  ## True delays
...
## Misspecify the incubation period
testpars$input_mean_inc = testpars$true_mean_inc + 2
testpars$input_sd_inc = testpars$true_sd_inc - .5
